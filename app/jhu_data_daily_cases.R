...
update_jhu = function(input_df, tag) {
  ...
  input_df$Country[input_df$Country=="Micronesia"] = "Micronesia,FederatedStatesof"
...
countries$jhu_ID[countries$jhu_ID=='Micronesia,FederatedStatesof']='Micronesia.FederatedStatesof'
