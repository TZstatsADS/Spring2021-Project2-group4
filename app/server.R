...
server = function(input, output, session) {
    ...
    output$multiplot <- renderPlot({
        ...
        ggplot()+
            ...
            geom_line(data= data_multi, aes(day, 100000*Average_Temp), color="green")+scale_y_continuous(name="Number of cases", sec.axis = sec_axis(trans=~.*0.00001, name="Avg. temp."))+ggtitle("Cases and Avg. temp. visualization") 
    })
